...
var Icon$2d = function (props) { return (React__default.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$1V = function (props) { return (React__default.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$1f = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default.createElement("image", { width: "32", height: "32", href: "/images/logo/logo-round.png" })));
};

var Icon$1e = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 512 512" }, props),
        React__default.createElement("image", { width: "512", height: "512", href: "/images/logo/logo-round.png" })));
};
...
var Logo$2 = function (_a) {
    ...
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 160 26" }, props),
        React__default.createElement("image", { width: "160", height: "26", href: "/images/logo/logo-white.png" })));
};
...
var Icon$_ = function (props) { return (React__default.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$X = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default.createElement("image", { width: "90", height: "90", href: "/images/logo/logo-round.png" })));
};

var Icon$W = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        React__default.createElement("image", { width: "64", height: "64", href: "/images/logo/logo-round.png" })));
};
...
var Icon$D = function (props) { return (React__default.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$o = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 80 80" }, props),
        React__default.createElement("image", { width: "80", height: "80", href: "/images/logo/ticket.png" })));
};
...
var Icon$m = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 48 48" }, props),
        React__default.createElement("image", { width: "80", height: "80", href: "/images/logo/ticket-round.png" })));
};
...
var Icon = function (props) {
    return (React__default.createElement(Svg, __assign({ width: "24px", height: "24px", viewBox: "0 0 0.45 0.45" }, props),
        React__default.createElement("path", { d: "M0 0.225a0.225 0.225 0 1 1 0.24 0.225V0.27h0.06V0.24H0.24V0.195A0.045 0.045 0 0 1 0.285 0.15h0.015V0.12h-0.015A0.075 0.075 0 0 0 0.21 0.195V0.24H0.15v0.03h0.06v0.18A0.225 0.225 0 0 1 0 0.225", fill: "#fff" })));
};
...
var ExpandableButton = function (_a) {
    ...
    return (React__default.createElement(IconButton, { "aria-label": "Hide or show expandable content", onClick: onClick },
        children,
        expanded ? React__default.createElement(Icon$1M, { color: "invertedContrast" }) : React__default.createElement(Icon$1P, { color: "invertedContrast" })));
};
...
var ExpandableLabel = function (_a) {
    var onClick = _a.onClick, expanded = _a.expanded, children = _a.children;
    return (React__default.createElement(Button, { variant: "text", "aria-label": "Hide or show expandable content", onClick: onClick, endIcon: expanded ? React__default.createElement(Icon$1M, { color: "primary" }) : React__default.createElement(Icon$1P, { color: "primary" }) }, children));
};
        ...
        React__default.createElement(Flex, { justifyContent: "flex-end" },
            ...
            switchEditingUnits && (React__default.createElement(Flex, { alignItems: "center", pl: "12px" },
                React__default.createElement(SwitchUnitsButton, { scale: "sm", variant: "text", onClick: switchEditingUnits },
                    React__default.createElement(Icon$u, { color: "textSubtle" })))))));
};
...
var DefaultSeparator = React__default.createElement(Icon$1N, { color: "currentColor", width: "24px" });
...
var UnmountAnimation = keyframes(templateObject_2$v || (templateObject_2$v = __makeTemplateObject(["\n    0% {\n      bottom: ", "px\n    }\n    100% {\n      bottom: ", "px;\n    }\n  "], ["\n    0% {\n      bottom: ", "px\n    }\n    100% {\n      bottom: ", "px;\n    }\n  "])), -window.innerHeight * 0.01, -window.innerHeight);
...
var StyledOverlay$1 = styled.div(templateObject_5$6 || (templateObject_5$6 = __makeTemplateObject(["\n  content: \"\";\n  position: fixed;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  background-color: ", ";\n  backdrop-filter: blur(1px);\n  z-index: 10;\n"], ["\n  content: \"\";\n  position: fixed;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  background-color: ", ";\n  backdrop-filter: blur(1px);\n  z-index: 10;\n"])), function (_a) {
    var theme = _a.theme;
...
var BottomDrawer = function (_a) {
    ...
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(StyledOverlay$1, null),
        createPortal(React__default.createElement(DrawerContainer, { ref: ref, isUnmounting: !isOpen },
            React__default.createElement(Box, { position: "absolute", right: "16px", top: "0" },
                React__default.createElement(IconButton, { variant: "text", onClick: function () { return setIsOpen(false); } },
                    React__default.createElement(Icon$1K, null))),
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default.createElement(PriceLink, { href: "https://sarcoinswap.com/swap?outputCurrency=0xca127b33f6e606660d8aba486a4b167fed4b5612", target: "_blank" },
        React__default.createElement(Icon$X, { width: "24px", mr: "8px" }),
...
var FallingBunnies = function (_a) {
    ...
    var bunnies = __spreadArray([], Array(count)).map(function (_, index) { return (React__default.createElement(Bunny, { key: String(index), position: Math.random() * 100, iterations: iterations, duration: duration },
        React__default.createElement(Icon$1f, { width: size, height: size }))); });
...
var StyledBunnyPlaceholder = styled(Icon$1X)(templateObject_2$p || (templateObject_2$p = __makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n"], ["\n  height: 100%;\n  width: 100%;\n"])));
...
var LinkExternal = function (_a) {
    ...
    return (React__default.createElement(Link, __assign({ external: true }, props),
        children,
        React__default.createElement(Icon$Y, { color: props.color ? props.color : "primary", ml: "4px" })));
};
...
var Progress = function (_a) {
    ...
    return (React__default.createElement(StyledProgress, { "$useDark": useDark, variant: variant, scale: scale },
        showProgressBunny && (React__default.createElement(ProgressBunnyWrapper, { style: { left: stepGuard(primaryStep) + "%" } },
            React__default.createElement(Icon$M, null))),
...
keyframes(templateObject_1$s || (templateObject_1$s = __makeTemplateObject(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"], ["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"])));
...
var FloatingPanIcon = styled(Icon$1f)(templateObject_4$6 || (templateObject_4$6 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var ModalCloseButton = function (_a) {
    ...
    return (React__default.createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
        React__default.createElement(Icon$1K, { color: "primary" })));
};
...
var StyledOverlay = styled.div(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["\n  content: \"\";\n  position: fixed;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  background-color: ", ";\n  backdrop-filter: blur(2px);\n"], ["\n  content: \"\";\n  position: fixed;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  background-color: ", ";\n  backdrop-filter: blur(2px);\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text + "99";
});
...
var DropdownMenu = function (_a) {
    ...
    return (React__default.createElement(Box, __assign({ ref: setTargetRef }, props),
        React__default.createElement(Box, { onTouchStart: function () {
...
var MenuItem = function (_a) {
    ...
    return (React__default.createElement(StyledFooter, __assign({ p: ["40px 16px", null, "56px 40px 32px 40px"] }, props, { justifyContent: "center" }),
        React__default.createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            React__default.createElement(StyledSocialLinks, { order: [1], pb: ["42px", null, "32px"], justifyContent: "center" }),
            React__default.createElement(Flex, { order: [2], p: ["30px"], justifyContent: "center" },
                React__default.createElement("p", { style: { color: '#fff' } }, "Copyright \u00A9 2024 Sarcoinswap. All Rights Reserved.")))));
};
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(Icon$1f, { className: "mobile-icon" }),
        React__default.createElement(LogoWithTextIcon, { className: "desktop-icon", isDark: isDark })));
    return (React__default.createElement(Flex, null, isAbsoluteUrl ? (React__default.createElement(StyledLink, { as: "a", href: href, "aria-label": "AstroFi home page" }, innerLogo)) : (React__default.createElement(StyledLink, { to: href, "aria-label": "AstroFi home page" }, innerLogo))));
};
...
var PendingMenuIcon = function () { return (React__default.createElement(MenuIconWrapper, { borderColor: "secondary" },
    React__default.createElement(Icon$J, { color: "secondary", width: "24px", spin: true }))); };
...
var UserMenu = function (_a) {
    ...
    return (React__default.createElement(Flex, __assign({ alignItems: "center", height: "100%", ref: setTargetRef }, props),
        React__default.createElement(StyledUserMenu, { onTouchStart: function () {
            ...
            React__default.createElement(Icon$1P, { color: "text", width: "24px" })),
...
var MoreWalletCard = function (_a) {
    ...
    return (React__default.createElement(WalletButton, __assign({ variant: "tertiary" }, props),
        React__default.createElement(Icon$13, { width: "40px", mb: "8px", color: "textSubtle" }),
...
export { Icon$2d as AccountFilledIcon, Icon$2c as AccountIcon, Icon$2b as AddIcon, Alert, Icon$29 as ArrowBackIcon, Icon$28 as ArrowDownIcon, Icon$27 as ArrowDropDownIcon, Icon$26 as ArrowDropUpIcon, Icon$25 as ArrowFirstIcon, Icon$24 as ArrowForwardIcon, Icon$23 as ArrowLastIcon, Icon$22 as ArrowUpIcon, Icon$21 as AutoRenewIcon, BackgroundImage, BalanceInput, GridLayout$1 as BaseLayout, BaseMenu, Icon$20 as BinanceChainIcon, Icon$1$ as BinanceIcon, Icon$2f as BlockIcon, Icon$1_ as BnbUsdtPairTokenIcon, BottomDrawer, Box, Breadcrumbs, Icon$2a as BridgeIcon, Icon$1Z as BscScanIcon, Icon$1Y as BunnyCardsIcon, Icon$1X as BunnyPlaceholderIcon, Button, ButtonMenu$1 as ButtonMenu, ButtonMenuItem, CakePrice$1 as CakePrice, Icon$1W as CalculateIcon, Icon$1V as CameraIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$1T as CardViewIcon, Icon$1U as Cards, GridLayout as CardsLayout, Icon$1S as ChartIcon, Checkbox, Icon$1R as CheckmarkCircleFillIcon, Icon$2h as CheckmarkCircleIcon, Icon$1Q as CheckmarkIcon, Icon$1P as ChevronDownIcon, Icon$1O as ChevronLeftIcon, Icon$1N as ChevronRightIcon, Icon$1M as ChevronUpIcon, Icon$1L as CircleOutlineIcon, ClickableElementContainer, Icon$1K as CloseIcon, Icon$1J as CogIcon, Icon$1I as Coin98Icon, Icon$1H as CommunityFilledIcon, Icon$1G as CommunityIcon, ConnectorNames, Icon$1F as CopyIcon, Icon$1E as CrownIcon, Icon$1D as CurrencyIcon, Icon$1C as DiscordIcon, Dropdown, DropdownMenuItemType, Icon$1A as EarnFillIcon, Icon$1B as EarnFilledIcon, Icon$1z as EarnIcon, Icon$1y as EllipsisIcon, Icon$2g as ErrorIcon, Icon$1x as ExpandIcon, ExpandableButton, ExpandableLabel, Icon as FacebookIcon, FallingBunnies, Icon$1w as FarmIcon, Flex, Icon$1v as GithubIcon, Grid, Icon$1t as GroupsIcon, Icon$1s as HamburgerCloseIcon, Icon$1r as HamburgerIcon, Heading, Icon$1q as HelpIcon, Icon$1p as HistoryIcon, Icon$1o as HomeIcon, IconButton, Icon$1n as IfoIcon, Image, Icon$2e as InfoIcon, InlineMenu, InlineMenuContainer, Input$1 as Input, InputGroup, Icon$1m as InstagramIcon, Icon$1l as LanguageCurrencyIcon, Icon$1k as LanguageIcon, Icon$1j as LaurelLeftIcon, Icon$1i as LaurelRightIcon, Link, LinkExternal, Icon$1h as ListViewIcon, Icon$1g as LoginIcon, Icon$1f as LogoIcon, Icon$1e as LogoRoundIcon, LogoWithTextIcon, Icon$1d as LogoutIcon, Icon$1c as MathWalletIcon, Icon$1b as MedalBronzeIcon, Icon$1a as MedalGoldIcon, Icon$19 as MedalPurpleIcon, Icon$18 as MedalSilverIcon, Icon$17 as MedalTealIcon, Icon$1u as MediumIcon, Menu$1 as Menu, Message, Icon$16 as MetamaskIcon, Icon$15 as MinusIcon, Modal, ModalBackButton, ModalBody, ModalCloseButton, ModalContainer, ModalHeader, ModalProvider, ModalTitle, Icon$14 as MoonIcon, Icon$13 as MoreHorizontalIcon, Icon$12 as MoreIcon, Icon$11 as MoreVerticalIcon, Icon$$ as NftFillIcon, Icon$10 as NftFilledIcon, Icon$_ as NftIcon, Icon$Z as NoProfileAvatarIcon, NotificationDot, Icon$Y as OpenNewIcon, Overlay, Icon$X as PancakeRoundIcon, PancakeToggle, Icon$W as PancakesIcon, Icon$V as PencilIcon, Icon$U as PlayCircleOutlineIcon, Icon$T as PocketWatchIcon, Icon$S as PoolIcon, Icon$R as PredictionsIcon, Icon$Q as PresentCheckIcon, Icon$P as PresentNoneIcon, Icon$O as PresentWonIcon, Icon$N as PrizeIcon, ProfileAvatar, Progress, Icon$M as ProgressBunny, Icon$L as ProposalIcon, Radio, Icon$K as RedditIcon, Icon$J as RefreshIcon, Icon$I as RemoveIcon, ResetCSS, Icon$H as ResourcesFilledIcon, Icon$G as ResourcesIcon, Icon$F as SafePalIcon, Icon$E as SearchIcon, Icon$D as SellIcon, Icon$C as ShareIcon, Icon$B as ShrinkIcon, Skeleton, Slider, Icon$A as SmallDotIcon, Spinner, Icon$z as StarFillIcon, Icon$y as StarLineIcon, Step, Stepper, SubMenu, SubMenuContainer, SubMenuItem, SubMenuItems, Icon$x as SunIcon, Svg, Icon$w as SwapFillIcon, Icon$v as SwapIcon, Icon$u as SwapVertIcon, Icon$t as SyncAltIcon, Tab, ButtonMenu as TabMenu, Table, Tag, Td, Icon$s as TeamBattleIcon, Icon$r as TeamPlayerIcon, Icon$q as TelegramIcon, Icon$p as TestnetIcon, Text, Textfield as TextField, Th, ThemeSwitcher$1 as ThemeSwitcher, Icon$o as Ticket, Icon$n as TicketFillIcon, Icon$o as TicketIcon, Icon$m as TicketRound, Timeline, Icon$l as TimerIcon, Toggle, TokenImage, TokenPairImage, Icon$k as TokenPocketIcon, TooltipText, Icon$j as TradeFilledIcon, Icon$i as TradeIcon, Icon$h as TrophyFillIcon, Icon$g as TrophyGoldIcon, Icon$f as TrophyIcon, Icon$e as TrustWalletIcon, Icon$d as TuneIcon, Icon$c as TwitterIcon, UserMenu, UserMenuDivider, UserMenuItem, Icon$b as VerifiedIcon, Icon$a as VisibilityOff, Icon$9 as VisibilityOn, Icon$8 as VolumeOffIcon, Icon$7 as VolumeUpIcon, Icon$6 as VoteIcon, Icon$5 as WaitIcon, Icon$4 as WalletConnectIcon, Icon$3 as WalletFilledIcon, Icon$2 as WalletIcon, Icon$1 as WarningIcon, variants$5 as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, status as menuStatus, useDelayedUnmount, useKonamiCheatCode, useMatchBreakpoints, useModal, useOnClickOutside, useParticleBurst, useTable, useTooltip, useWalletModal };

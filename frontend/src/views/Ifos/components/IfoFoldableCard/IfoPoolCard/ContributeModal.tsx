      ...
      <ModalBody maxWidth="420px">
        ...
        <Flex justifyContent="space-between" mb="8px">
          ...
          <Flex flexGrow={1} justifyContent="flex-end">
            <Image
              src={
                ifo.currency.symbol === 'SRS'
                  ? '/images/idos/dogon.png'
                  : `/images/idos/${currency.symbol.split(' ')[0].toLocaleLowerCase()}.png`
              }
              width={24}
              height={24}
            />
            <Text style={{paddingLeft: '5px'}}>{currency.symbol}</Text>
          </Flex>
        </Flex>
        <BalanceInput
          value={value}
        ...
        <Text color="textSubtle" fontSize="12px" mb="24px">
          {t(
            'If you don’t commit enough %symbol%, you may not receive any IDO tokens at all and will only receive a full refund of your %symbol%.',

...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and SRS pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and SRS pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from SRS pool', data)
  }

...
const NextDrawCard = () => {
  ...
  const { endTime, amountCollectedInDogon, userTickets, status } = currentRound
  ...
  const prizeInBusd = amountCollectedInDogon.times(cakePriceBusd)
      ...
      <>
        ...
        {prizeInBusd.isNaN() ? (
          ...
          <Balance
            ...
            textAlign={['center', null, null, 'left']}
            unit=" SRS"
            value={getBalanceNumber(amountCollectedInDogon)}
            decimals={0}
          />
        )}
      </>

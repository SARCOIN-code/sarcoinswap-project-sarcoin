...
export const INFO_CLIENT = 'https://api.thegraph.com/subgraphs/name/dogonswap/exchange'
export const BLOCKS_CLIENT = 'https://api.thegraph.com/subgraphs/name/dogonswap/blocks'
